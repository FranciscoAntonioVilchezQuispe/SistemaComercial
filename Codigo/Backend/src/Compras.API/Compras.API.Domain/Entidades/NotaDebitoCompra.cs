...
{
    [Table("nota_debito", Schema = "compras")]
    public class NotaDebitoCompra : EntidadBase
    {
        [Key]
        [Column("id_nota")]
        ...
        public virtual ICollection<NotaDebitoDetalleCompra> Detalles { get; set; } = new List<NotaDebitoDetalleCompra>();
    }
}
