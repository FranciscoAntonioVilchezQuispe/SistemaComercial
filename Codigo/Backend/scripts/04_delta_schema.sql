...
BEGIN
    ...
    WHERE codigo = '1' AND id_tabla = (
        SELECT id_tabla FROM configuracion.tablas_generales WHERE codigo = 'TIPO_DOCUMENTO'
    ) LIMIT 1;
    
    SELECT id_detalle INTO v_ruc_old_id 
    FROM configuracion.tablas_generales_detalle 
    WHERE codigo = '6' AND id_tabla = (
        SELECT id_tabla FROM configuracion.tablas_generales WHERE codigo = 'TIPO_DOCUMENTO'
    ) LIMIT 1;
    
    SELECT id_detalle INTO v_carnet_old_id 
    FROM configuracion.tablas_generales_detalle 
    WHERE codigo = '4' AND id_tabla = (
        SELECT id_tabla FROM configuracion.tablas_generales WHERE codigo = 'TIPO_DOCUMENTO'
    ) LIMIT 1;
    
    SELECT id_detalle INTO v_pasaporte_old_id 
    FROM configuracion.tablas_generales_detalle 
    WHERE codigo = '7' AND id_tabla = (
        SELECT id_tabla FROM configuracion.tablas_generales WHERE codigo = 'TIPO_DOCUMENTO'
    ) LIMIT 1;
